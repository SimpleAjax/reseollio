...
import { pauseSchedule, scheduleStatusToString, type Schedule as GrpcSchedule } from "@/lib/grpc-client";
...
export async function POST(
    ...
    try {
        ...
        console.error("[API] Error pausing schedule:", error);
        return NextResponse.json(
            { success: false, error: "Failed to pause schedule", details: error.message },
            { status: 500 }
        );
    }
}
